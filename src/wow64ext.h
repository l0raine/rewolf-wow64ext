...
DWORD64 VirtualQueryEx64(HANDLE hProcess, DWORD64 lpAddress, MEMORY_BASIC_INFORMATION64* lpBuffer, SIZE_T dwLength);
DWORD64 VirtualQueryEx64(HANDLE hProcess, DWORD64 lpAddress, MEMORY_INFORMATION_CLASS mic, DWORD64 lpBuffer, SIZE_T dwLength);
DWORD64 VirtualAllocEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flAllocationType, DWORD flProtect);

DWORD64 VirtualFreeEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD dwFreeType);
DWORD64 VirtualProtectEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flNewProtect, DWORD* lpflOldProtect);
DWORD64 ReadProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesRead);
DWORD64 WriteProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesWritten);
DWORD64 GetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext);
DWORD64 SetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext);
